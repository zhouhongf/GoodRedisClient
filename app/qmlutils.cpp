...
#include <QUrl>
#include "thirdparty/singleheader/simdjson.h"
...
void QmlUtils::addNewValueToDynamicChart(QtCharts::QXYSeries *series, qreal value) {
  using namespace QtCharts;
...
QObject *QmlUtils::wrapLargeText(const QByteArray &text) {
  ...
  int chunkSize = 50000;
  auto w = new ValueEditor::LargeTextWrappingModel(QString::fromUtf8(text), chunkSize);
  w->setParent(this);
  return w;
}
