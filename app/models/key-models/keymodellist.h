...
public:
    ListKeyModel(QSharedPointer<RedisClient::Connection> connection, QByteArray fullPath, int dbIndex, long long ttl);
    QString type() override;

    virtual void updateRow(int rowIndex, const QVariantMap &, ValueEditor::Model::Callback c) override;
