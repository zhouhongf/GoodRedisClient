 ...
 */
    struct MYDLL_EXPORT ServerInfo {
        ServerInfo();
        ...
        class __declspec(dllexport) ParsedServerInfo : public QHash<QString, QHash<QString, QString>> {
        public:
 ...
 * Main client class.
 */
    class MYDLL_EXPORT Connection : public QObject {
    Q_OBJECT
    ADD_EXCEPTION
    ...
    public:
        enum class Mode {
            Normal, PubSub, Cluster, Sentinel
        };
