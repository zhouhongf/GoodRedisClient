...
class MYDLL_EXPORT QVariantListBuilder : public ListBuilder<QVariant> {
    public:
...
class MYDLL_EXPORT QVariantDictBuilder : public DictBuilder<QVariant> {
    public:
...
class MYDLL_EXPORT QVariantListIterator : public ListIterator<QVariant> {
    public:
...
class MYDLL_EXPORT QVariantDictIterator : public DictIterator<QVariant> {
    public:
...
class MYDLL_EXPORT QVariantConverter : public Converter<QVariant> {
    public:
