...
class MYDLL_EXPORT PyObjectListBuilder : public ListBuilder<PyObject *> {
public:
...
class MYDLL_EXPORT PyObjectDictBuilder : public DictBuilder<PyObject *> {
public:
...
class MYDLL_EXPORT PyObjectListIterator : public ListIterator<PyObject *> {
public:
    PyObjectListIterator(PyObject *&v)
            : list(v), iter(PyObject_GetIter(list)), ref(NULL) {
        if (iter == NULL) {
            // TODO: Handle error
        }
    }
...
class MYDLL_EXPORT PyObjectDictIterator : public DictIterator<PyObject *> {
public:
...
class MYDLL_EXPORT PyObjectConverter : public Converter<PyObject *> {
public:
