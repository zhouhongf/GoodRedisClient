...
struct MYDLL_EXPORT ConverterDate {
...
struct MYDLL_EXPORT ConverterTime {
...
struct MYDLL_EXPORT ConverterDateTime : public ConverterDate {
    ConverterDateTime(int y, int m, int d, int h, int mm, int s, int ms)
            : ConverterDate(y, m, d), time(h, mm, s, ms) {
    }
...
template<class V>
class MYDLL_EXPORT ListBuilder {
public:
    ListBuilder() {}
...
template<class V>
class MYDLL_EXPORT DictBuilder {
public:
    DictBuilder() {}
...
template<class V>
class MYDLL_EXPORT ListIterator {
public:
    ListIterator() {}
...
template<class V>
class MYDLL_EXPORT DictIterator {
public:
    DictIterator() {}
