...
class MYDLL_EXPORT QPython : public QObject {
Q_OBJECT
...
public:
     ...
     **/
    Q_INVOKABLE void setHandler(QString event, QJSValue callback);
     ...
     **/
    Q_INVOKABLE QVariant evaluate(QString expr);
     ...
     **/
    Q_INVOKABLE QVariant getattr(QVariant obj, QString attr);
     ...
     **/
    Q_INVOKABLE QString pluginVersion();
     ...
     **/
    Q_INVOKABLE QString pythonVersion();
...
class MYDLL_EXPORT QPython10 : public QPython {
// Q_OBJECT
public:
...
class MYDLL_EXPORT QPython12 : public QPython {
// Q_OBJECT
public:
...
class MYDLL_EXPORT QPython13 : public QPython {
// Q_OBJECT
public:
...
class MYDLL_EXPORT QPython14 : public QPython {
// Q_OBJECT
public:
...
class MYDLL_EXPORT QPython15 : public QPython {
// Q_OBJECT
public:
