...
class MYDLL_EXPORT QObjectRef : public QObject {
    Q_OBJECT
...
class MYDLL_EXPORT QObjectMethodRef {
public:
    QObjectMethodRef(const QObjectRef &object, const QString &method) : m_object(object), m_method(method){
    }
